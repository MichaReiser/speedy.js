...
async function getWasmFunctionForTestCase(caseName) {
    ...
    const wasmModule = require("speedyjs-loader?{speedyJS:{unsafe: true, totalMemory: 134217728, exportGc: true, disableHeapNukeOnExit: true, optimizationLevel: 2}}!./cases/mergeSort.ts");
